...
async function deleteData(id) {
    ...
    let res = await fetch(`https://htmlcssjavascript-projects-4.onrender.com/Products/${id}`, { "method": "DELETE" });
    try {
        if (!res.ok) {
            throw new Error("Something Went Wrong");
        }
...
async function editData(id) {
    ...
    let res = await fetch(`https://htmlcssjavascript-projects-4.onrender.com/Products/${id}`)
    try {
        if (!res.ok) {
            throw new Error("Something Went Wrong");
        }
...
async function savedbtn(){
    ...
    let productsId=itemId?`https://htmlcssjavascript-projects-4.onrender.com/Products/${itemId}`:"https://htmlcssjavascript-projects-4.onrender.com/Products";
